# SUPER ENSKRIPSI TRANSPOSISI SPIRAL --> HILL CHIPER
import string
import math
import numpy as np
import random
...
def spiral_encrypt():  # Fungsi untuk enkripsi
...
def spiral_decrypt(cipher_text):  # Fungsi untuk dekripsi
    ...
    print(plain_text)
    return plain_text.replace(spasi, ' ')  # Kembalikan - menjadi spasi
...
def main():
    while (1):
        ...
        if choice == 1:
            ...
            print("Plain text : ", spiral_decrypt(hill_decript()))
